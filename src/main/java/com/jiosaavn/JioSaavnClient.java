...
/**
 * The main client for interacting with the JioSaavn API. This class provides access to various
 * services for retrieving album, artist, playlist, search, and song information.
 */
public class JioSaavnClient {
  ...
  /** Constructs a new {@code JioSaavnClient} instance, initializing all available API services. */
