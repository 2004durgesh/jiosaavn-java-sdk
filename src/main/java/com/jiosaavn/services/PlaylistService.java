...
/**
 * Service class for interacting with JioSaavn playlist-related APIs. This class extends {@link
...
public class PlaylistService extends BaseService {
  ...
  public Playlist.PlaylistModel getPlaylistById(String id) throws IOException {
    ...
    Playlist.PlaylistAPIResponseModel response =
        fetchFromApi(
            Endpoints.Playlists.ID,
            params,
            Playlist.PlaylistAPIResponseModel.class,
            ApiContext.web6dot0);
