...
/**
 * Service class for interacting with JioSaavn album-related APIs. This class extends {@link
...
public class AlbumService extends BaseService {
  ...
  public Album.AlbumModel getAlbumById(String id) throws IOException {
    ...
    Album.AlbumAPIResponseModel response =
        fetchFromApi(
            Endpoints.Albums.ID, params, Album.AlbumAPIResponseModel.class, ApiContext.web6dot0);
