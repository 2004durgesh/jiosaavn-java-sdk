...
/**
 * Service class for interacting with JioSaavn artist-related APIs.
...
public class ArtistService extends BaseService {
    ...
    /**
     * Retrieves details of an artist by their ID, using default pagination and sorting.
     * Defaults to page 0, 50 songs, 50 albums, sorted by popularity in ascending order.
     *
